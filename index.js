...
const Game = {
	...
	fruitSizes: [
		...
		{ radius: 40,  scoreValue: 3,  img: './assets/img/circle0.png' },
		{ radius: 60,  scoreValue: 6,  img: './assets/img/circle0.png' },
		{ radius: 84,  scoreValue: 10, img: './assets/img/circle0.png' },
		{ radius: 112, scoreValue: 15, img: './assets/img/circle0.png' },
		{ radius: 144, scoreValue: 21, img: './assets/img/circle0.png' },
		{ radius: 176, scoreValue: 28, img: './assets/img/circle0.png' },
		{ radius: 210, scoreValue: 36, img: './assets/img/circle0.png' },
	],
	currentFruitSize: 0,
	nextFruitSize: 0,
